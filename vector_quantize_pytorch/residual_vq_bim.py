...
class ResidualVQ(nn.Module):
    ...
    def forward(
        ...
        for quantizer_index, layer in enumerate(self.layers):
            ...
            # what is indices?
            ###################Those parts are I need to change##################################
            quantized, *rest = layer(residual, indices = layer_indices, sample_codebook_temp = sample_codebook_temp) # input x, return qunatized value and CE Loss

            residual = residual - quantized.detach() # Subtract
            quantized_out = quantized_out + quantized # Sum for output # What if I don't sum the codes? Is there any other way?
