...
def main(cfg):
    ...
    train_loader = torch.utils.data.DataLoader(
        train_data, batch_size=cfg.batch_size, shuffle=False, pin_memory=False
    )
    ...
    def eval_on_env(
        ...
        for goal_idx in range(num_evals):
            ...
            for _ in range(num_eval_per_goal):
                ...
                while not done or step <= 1300:
                    ...
                    action, _, _ = cbet_model(obs.unsqueeze(0), None, None)
        ...
        return (
            ...
            f'eval_{epoch}_{goal_idx}.mp4'
        )

    for epoch in tqdm.trange(cfg.epochs):
        # cbet_model.eval()
        # if (epoch % cfg.eval_on_env_freq == 0):
        #     avg_reward, video_dir = eval_on_env(
        #         cfg,
        #         videorecorder=video,
        #         epoch=epoch,
        ...
        #     wandb.log({"video": wandb.Video(str(save_path / video_dir))})
